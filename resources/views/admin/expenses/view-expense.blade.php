...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 text-gray-800" style="color:black !important; font-weight: 600; font-size: 28px;">
            <a href="{{ route('expense-list') }}" style="text-decoration: none; color: black;">Expense/</a><span style="color:black !important; font-weight: 600; font-size: 22px;">View Expense Report</span>
        </h1>
    </div>
        ...
        <div class="col-md-12">
            <div class="card mb-4" style="box-shadow: 0 4px 8px rgba(216, 64, 85, 0.5) !important;">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="detail-group">
                                <h6>Date</h6>
                                <p class="mb-20">{{ \Carbon\Carbon::parse($expense->date)->format('F d Y') }}</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="detail-group">
                        ...
                        <div class="col-md-4">
                            <div class="detail-group">
                                <h6>Remark</h6>
                                <p class="mb-20">{{$expense->note_remarks ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-footer text-right">
                    <a href="{{route('expense-list')}}" class="btn btn-secondary">Back to Expense List</a>
                </div>
            </div>
