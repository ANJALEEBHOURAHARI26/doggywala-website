...
table.dataTable {
  ...
  @media (max-width: 575.98px) {
    ...
    .tabs {
      display: flex;
      overflow-x: auto;
      /* Horizontal scroll enable karega */
      white-space: nowrap;
      /* Buttons ek line me rahenge */
      padding: 10px;
      max-width: 100%;
      /* Card ke andar fit hoga */
      scrollbar-width: thin;
      /* Firefox ke liye scrollbar thin karega */
    }
    ...
    .tabs button {
      flex-shrink: 0;
      /* Buttons scroll hone par collapse nahi honge */
      margin-right: 10px;
    }
  }
...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <h1 class="h3 mb-0 text-gray-800" style=" color:black !important; font-weight: 600; font-size: 28px;">Employer/<span
        style=" color:black !important; font-weight: 600; font-size: 22px;">Staff List</span></h1>
      ...
      <div class="card mb-4" style="box-shadow: 0 4px 8px rgba(216, 64, 85, 0.5) !important;">
        <div class="tabs">
          ...
          <button class="btn btn-primary detail-prject"
            style="background: linear-gradient(90deg, #3136C1 0%, #D84055 100%); border: none;margin-left: 10px;padding: 7px 30px !important;">Staff</button>
          ...
          <table class="table align-items-center table-flush custom-table" id="dataTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    {{ $employeeDetail->modelHasRole ? $employeeDetail->modelHasRole->role->name : 'No Role Assigned' }}
                </td>
                ...
                @endphp
                    ...
                    @if($userType == 'Admin' || in_array('role_assign', $permissionsArray))
                    <a href="#" class="role-assign-btn" data-toggle="modal" data-target="#roleAssignModal"
                    data-id="{{ $employeeDetail->id }}"
                    data-url="{{ route('role.assign', $employeeDetail->id) }}" title="Role Assign"> 
                       <img src="{{ asset('assets/img/right-icon.png') }}" alt="Role Assign">
                    </a>
                    @include('admin.employer.assign-role-model')
                    @else
                        <a href="#" onclick="showRoleAssignPermissionError()" title="Role Assign">
                            <img src="{{ asset('assets/img/right-icon.png') }}" alt="Role Assign">
                        </a>
                    @endif
                ...
                <script>
                    ...
                    function showRoleAssignPermissionError() {
                        alert('❌ You don\'t have permission to assign a role!');
                    }
                </script>
                </td>
              </tr>
...
<footer class="sticky-footer bg-white">
  <div class="container my-auto">
    <div class="copyright text-center my-auto">
      <span>copyright &copy;
        <script> document.write(new Date().getFullYear()); </script> - design & developed by
...
<script>
    $(document).ready(function() {
        $('.role-assign-btn').click(function() {
            let employeeId = $(this).data('id'); 
            let assignUrl = $(this).data('url'); 
            
            $('#user_id').val(employeeId); 
            $('#roleAssignForm').attr('action', assignUrl); 
        });
    });
</script>
