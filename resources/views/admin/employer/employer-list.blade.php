...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800" style=" color:black !important; font-weight: 600; font-size: 28px;">Employer /
        <span style=" color:black !important; font-weight: 600; font-size: 22px;">Employer List</span></h1>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4" style="box-shadow: 0 4px 8px rgba(216, 64, 85, 0.5) !important;">
                <div class="tabs">
                    ...
                    style="background: linear-gradient(90deg, #3136C1 0%, #D84055 100%); border: none; padding: 7px 30px !important;">Worker</button>
                ...
                <div class="table-responsive p-3">
                    <table class="table align-items-center table-flush custom-table" id="dataTable">
                        <thead class="thead-light">
                            <tr>
                                <th style="border: 1px solid white;">Joining Date</th>
                                <th>Name</th>
