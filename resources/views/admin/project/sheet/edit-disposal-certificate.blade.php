<div class="modal fade" id="editDisposalCertificate" tabindex="-1" role="dialog" aria-labelledby="editDisposalCertificate" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #D84055; color: #fff;">
                <h5 class="modal-title" id="editDisposalCertificate">Edit Disposal Certificate</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="disposalCertificateForm" action="{{ route('update.project.disposalCertificate', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT') 
                    ...
                    <div class="form-group">
                        ...
                        <div id="disposalCertificate" class="mt-2">
                            @php
                                $filePath = url('uploads/DisposalCertificate/' . $data->receipt_upload);
                                $fileExtension = strtolower(pathinfo(public_path('uploads/DisposalCertificate/' . $data->receipt_upload), PATHINFO_EXTENSION));
                            @endphp
