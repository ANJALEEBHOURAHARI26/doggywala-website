...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 text-gray-800" style="color:black !important; font-weight: 600; font-size: 28px;">
            Disposal Certificate/ <span style="color:black !important; font-weight: 600; font-size: 22px;">View Disposal Certificate</span>
        </h1>
    </div>
        ...
        <div class="col-md-12">
            <div class="card mb-4" style="box-shadow: 0 4px 8px rgba(216, 64, 85, 0.5) !important;">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="detail-group">
                                <h6>Receipt Image</h6>
                                <p class="mb-20">
                                    @if($disposalCertificate->receipt_upload)
                                        <div class="mt-2">
                                            @php
                                                $filePath = asset($disposalCertificate->receipt_upload);
                        ...
                        <div class="col-md-4">
                            <div class="detail-group">
                                <h6>Type</h6>
                                <p class="mb-20">{{$disposalCertificate->description ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-footer text-right">
                    <a href="{{ route('project-DisposalCertificate', ['projectId' => $disposalCertificate->project_id, 'sheetId' => $disposalCertificate->sheet_id]) }}" class="btn btn-secondary">
                        Clearance Report
                    </a>
                </div>
            </div>
