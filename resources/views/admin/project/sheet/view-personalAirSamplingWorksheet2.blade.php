...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 text-gray-800" style="color:black !important; font-weight: 600; font-size: 28px;">
            Personal Air Sampling Worksheet2/ <span style="color:black !important; font-weight: 600; font-size: 22px;">View Personal Air Sampling Worksheet2</span>
        </h1>
    </div>
        ...
        <div class="col-md-12">
            <div class="card mb-4" style="box-shadow: 0 4px 8px rgba(216, 64, 85, 0.5) !important;">
                <div class="card-header text-white" style="background-color: #D84055; font-size: 20px; font-weight: bold;">
                   Personal Air Sampling Worksheet2
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="detail-group">
                                <h6>Receipt Image</h6>
                                <p class="mb-20">
                                    @if($personalAirSamplingWorksheet2->receipt_image)
                                        <div class="mt-2">
                                            @php
                                                $filePath = asset($personalAirSamplingWorksheet2->receipt_image);
                        ...
                        <div class="col-md-4">
                            <div class="detail-group">
                                <h6>Type</h6>
                                <p class="mb-20">{{$personalAirSamplingWorksheet2->description ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-footer text-right">
                    <a href="{{ route('project-Personal-Air-Sampling-Worksheet-2', ['projectId' => $personalAirSamplingWorksheet2->project_id, 'sheetId' => $personalAirSamplingWorksheet2->sheet_id]) }}" class="btn btn-secondary">
                        Back to Personal Air Sampling Worksheet List
                    </a>
                </div>
            </div>
