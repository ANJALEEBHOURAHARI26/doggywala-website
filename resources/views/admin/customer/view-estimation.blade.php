...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 text-gray-800" style="color:black !important; font-weight: 600; font-size: 28px;">
            <a href="{{ route('project-estimation-second') }}" style="text-decoration: none; color: black;">Estimation</a> / <span style="color:black !important; font-weight: 600; font-size: 22px;">View Estimation</span>
        ...
        <div class="col-md-12">
            <div class="card mb-4" style="box-shadow: 0 4px 8px rgba(216, 64, 85, 0.5) !important;">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="detail-group">
                            ...
                            <a href="{{ route('estimation.second.download', $estimationDetails->id) }}" class="btn btn-success d-block mx-auto mt-2">
                                Download as PDF
                            </a>
                        </div>
                ...
                <div class="card-footer text-right">
                    <a href="{{route('project-estimation-second')}}" class="btn btn-secondary">Back to Estimation List</a>
                </div>
            </div>
