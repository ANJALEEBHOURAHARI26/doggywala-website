  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 text-white">
        <h1 class="display-4 fw-bold mt-5">Welcome to Premium Dog Daycare</h1>
        <p class="lead">Safe, fun, and engaging daycare for your beloved dogs while you're at work. Book your dog's day today!</p>
      </div>
    </div>
  </div>
</section>
...
<section class="py-5 bg-light">
  <div class="container">
    <h2 class="text-center fw-bold mb-5" style="color:#1f2e4d; font-size: 2.5rem;">Our Premium Dog Daycare Services</h2>

    <div class="row align-items-center mb-5">
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="{{ asset('uploads/pet-daycare/pexels-yaroslav-shuraev-9632590.jpg') }}" alt="Dog Daycare Play Time" class="img-fluid rounded shadow w-100" style="max-height: 400px; object-fit: cover;">
      </div>
      <div class="col-md-6">
        <h3 class="fw-bold mb-3" style="color:#1f2e4d; font-size: 1.75rem;">All-Day Dog Daycare</h3>
        <p style="font-size: 1.15rem; line-height: 1.9; color:#555;">
          Your dog will enjoy a full day of supervised play, exercise, and socialization in our secure indoor and outdoor facilities. Our trained staff ensures each dog gets individual attention, regular potty breaks, and structured activities to keep them happy and engaged throughout the day.
        </p>
      </div>
    </div>
    ...
    <div class="row align-items-center mb-5 flex-md-row-reverse">
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="{{ asset('uploads/pet-daycare/pexels-leonardo-merlo-1124828-18834955.jpg') }}" alt="Dog Social Play" class="img-fluid rounded shadow w-100" style="max-height: 400px; object-fit: cover;">
      </div>
      <div class="col-md-6">
        <h3 class="fw-bold mb-3" style="color:#1f2e4d; font-size: 1.75rem;">Dog Socialization & Play</h3>
        <p style="font-size: 1.15rem; line-height: 1.9; color:#555;">
          Perfect for dogs who love making friends! Our supervised group play sessions help dogs develop social skills, burn energy, and have fun with other furry companions. We carefully match dogs by size, temperament, and play style for safe interactions.
        </p>
      </div>
    </div>
    ...
    <div class="row align-items-center mb-5">
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="{{ asset('uploads/pet-daycare/pexels-conejodepapel-19017773.jpg') }}" alt="Dog Training & Activities" class="img-fluid rounded shadow w-100" style="max-height: 400px; object-fit: cover;">
      </div>
      <div class="col-md-6">
        <h3 class="fw-bold mb-3" style="color:#1f2e4d; font-size: 1.75rem;">Training & Enrichment Activities</h3>
        <p style="font-size: 1.15rem; line-height: 1.9; color:#555;">
          Beyond play, we offer basic training reinforcement, mental stimulation puzzles, and enrichment activities to keep your dog's mind sharp. Our structured programs include obedience practice, interactive games, and educational activities that support your dog's development.
        </p>
      </div>
    </div>
...
<section class="dog-daycare-section">
    <div class="section-header">
        <h2 class="section-title">Why Choose Home-Style Dog Daycare?</h2>
    </div>
    
    <div class="section-description">
        Traditional dog daycare facilities often keep dogs in kennels or sterile environments with limited social interaction and minimal personal attention. Many commercial facilities prioritize quantity over quality, resulting in stressed dogs and inadequate supervision. Our home-style dog daycare is different - we provide a warm, family-like environment where your dog receives personalized care and attention. Our experienced dog lovers treat each dog as part of their own family, ensuring your furry friend gets plenty of exercise, socialization, and love throughout the day. Unlike crowded facilities, we maintain small groups to ensure quality interaction and individual attention. Your dog will enjoy spacious indoor and outdoor areas, comfortable rest spaces, and engaging activities tailored to their personality and energy level. We provide regular updates and photos so you can see how much fun your dog is having while you're at work.
    </div>
    <a href="#booking-form" class="book-now-btn" onclick="scrollToForm()">Book Now</a>
</section>

<section class="py-5" style="background-color: #f9fff9;">
  <div class="container">
    <h2 class="text-center mb-5 fw-bold" style="color: #1f2e4d;">Our Dog Daycare Services</h2>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-3">
        <div class="card h-100 shadow-sm text-center border-0">
          <a href="#" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <img src="{{ asset('uploads/pet-daycare/pexels-blue-bird-7210754.jpg') }}" alt="Full Day Daycare" class="img-fluid rounded mb-3">
              <h5 class="card-title">Full Day Daycare</h5>
              <p class="card-text">
                Complete daycare service with play, exercise, and supervised activities for your dog.
              </p>
            </div>
          </a>
        </div>
      ...
      <div class="col-md-3">
        <div class="card h-100 shadow-sm text-center border-0">
          <a href="#" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <img src="{{ asset('uploads/pet-daycare/pexels-gabesphotos-11512316.jpg') }}" alt="Dog Socialization" class="img-fluid rounded mb-3">
              <h5 class="card-title">Dog Socialization</h5>
              <p class="card-text">
                Supervised group play sessions to help your dog make friends and develop social skills.
              </p>
            </div>
          </a>
        </div>
      ...
      <div class="col-md-3">
        <div class="card h-100 shadow-sm text-center border-0">
          <a href="#" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <img src="{{ asset('uploads/pet-daycare/pexels-goochie-poochie-19145886.jpg') }}" alt="Half Day Care" class="img-fluid rounded mb-3">
              <h5 class="card-title">Half Day Care</h5>
              <p class="card-text">
                Perfect for shorter schedules - morning or afternoon sessions available for your dog.
              </p>
            </div>
          </a>
        </div>
      ...
      {{-- Box 4 --}}
       <div class="col-md-3">
          <div class="card h-100 shadow-sm text-center border-0">
            <a href="#" style="text-decoration: none; color: inherit;">
              <div class="card-body">
                <img src="{{ asset('uploads/pet-daycare/pexels-tima-miroshnichenko-6235244.jpg') }}" alt="Premium Dog Care" class="img-fluid rounded mb-3">
                <h5 class="card-title">Premium Dog Care</h5>
                <p class="card-text">
                  VIP treatment with one-on-one attention, special activities, and extra comfort for your beloved dog.
                </p>
              </div>
            </a>
          </div>
...
<section class="py-5 booking-form-section" style="background-color: #f3f6fa;" id="booking-form">
  <div class="container">
    <h2 class="text-center fw-bold mb-4" style="color: #1f2e4d;">Book Dog Daycare Appointment</h2>
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <form id="bookingForm" action="{{ route('booking.submit') }}" method="POST" onsubmit="handleSubmit(this)">
          ...
          <div class="mb-3">
            <label for="service" class="form-label">Select Dog Daycare Service <span class="text-danger">*</span></label>
            <select class="form-select" id="service" name="service" required="">
              <option value="" disabled="" selected="">-- Select Dog Daycare Service --</option>
               <option value="Full Day Dog Daycare">Full Day Dog Daycare</option>
                <option value="Half Day Dog Daycare">Half Day Dog Daycare</option>
                <option value="Dog Socialization Sessions">Dog Socialization Sessions</option>
                <option value="Premium Dog Daycare">Premium Dog Daycare (All Services)</option>
                <option value="Dog Training & Daycare">Dog Training & Daycare</option>
                <option value="Dog Exercise & Play">Dog Exercise & Play</option>
                <option value="Weekend Dog Daycare">Weekend Dog Daycare</option>
                <option value="Dog Grooming & Daycare">Dog Grooming & Daycare</option>
                <option value="Senior Dog Daycare">Senior Dog Daycare</option>
                <option value="Puppy Daycare">Puppy Daycare</option>
              </select>
          </div>
    ...
    <div class="time-slots-container" id="timeSlotsContainer" style="display: none;">
        ...
        <div class="time-slots-content">
          ...
          <div class="mb-3">
            <label for="message" class="form-label">Special Instructions for Your Dog (Optional)</label>
            <textarea class="form-control" id="message" name="message" rows="4" placeholder="Tell us about your dog's needs, preferences, or any special requirements..."></textarea>
          </div>

          <button type="submit" class="btn btn-success w-100" id="submitBtn">
            <span id="btnText">Book Dog Daycare Now</span>
