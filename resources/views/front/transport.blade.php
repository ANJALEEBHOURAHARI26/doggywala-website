...
@section('main')
<section class="section-02" style="background-image: url('{{ asset('uploads/pet-transport/petbacker-pet-taxi-1800x450.jpg') }}');">
  <div class="container">
    <div class="row">
      <div class="col-lg-8 text-white">
        <h1 class="display-4 fw-bold mt-5">Professional Pet Transport Services</h1>
        <p class="lead">Safe door-to-door transport services for your beloved pets. Reliable and comfortable travel solutions with experienced handlers!</p>
      </div>
    </div>
  </div>
</section>
...
<section class="py-5 bg-light">
  <div class="container">
    <h2 class="text-center fw-bold mb-5" style="color:#1f2e4d; font-size: 2.5rem;">Our Professional Pet Transport Services</h2>

    <div class="row align-items-center mb-5">
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="{{ asset('uploads/pet-transport/pexels-patricia-merl-1030568321-31751810.jpg') }}" alt="Pet Transport Services" class="img-fluid rounded shadow w-100" style="max-height: 400px; object-fit: cover;">
      </div>
      <div class="col-md-6">
        <h3 class="fw-bold mb-3" style="color:#1f2e4d; font-size: 1.75rem;">Local Pet Transport</h3>
        <p style="font-size: 1.15rem; line-height: 1.9; color:#555;">
          Safe and reliable local pet transport services for veterinary visits, grooming appointments, and short-distance relocations. Our climate-controlled vehicles and experienced pet handlers ensure your furry friends travel comfortably and stress-free. We provide door-to-door pickup and delivery with real-time updates throughout the journey.
        </p>
      </div>
    </div>
    ...
    <div class="row align-items-center mb-5 flex-md-row-reverse">
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="{{ asset('uploads/pet-transport/pexels-robertkso-17206212.jpg') }}" alt="Long Distance Transport" class="img-fluid rounded shadow w-100" style="max-height: 400px; object-fit: cover;">
      </div>
      <div class="col-md-6">
        <h3 class="fw-bold mb-3" style="color:#1f2e4d; font-size: 1.75rem;">Long Distance Transport</h3>
        <p style="font-size: 1.15rem; line-height: 1.9; color:#555;">
          Professional long-distance pet transport services for interstate moves and relocations. Our specialized vehicles are equipped with secure carriers, proper ventilation, and temperature control. We handle all necessary documentation, health certificates, and provide regular updates to pet owners during extended journeys.
        </p>
      </div>
    </div>
    ...
    <div class="row align-items-center mb-5">
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="{{ asset('uploads/pet-transport/pexels-ozgur-surmeli-124841273-11782300.jpg') }}" alt="Emergency Transport" class="img-fluid rounded shadow w-100" style="max-height: 400px; object-fit: cover;">
      </div>
      <div class="col-md-6">
        <h3 class="fw-bold mb-3" style="color:#1f2e4d; font-size: 1.75rem;">Emergency Pet Transport</h3>
        <p style="font-size: 1.15rem; line-height: 1.9; color:#555;">
          24/7 emergency pet transport services for urgent veterinary care and critical situations. Our rapid response team is equipped to handle medical emergencies with specialized first-aid trained drivers and emergency medical equipment. We coordinate directly with veterinary hospitals for seamless care transitions.
        </p>
      </div>
    </div>
...
<section class="pet-walking-section">
    <div class="section-header">
        <h2 class="section-title">Why Choose Professional Pet Transport Services?</h2>
    </div>
    
    <div class="section-description">
        Pet transportation requires specialized knowledge, proper equipment, and trained professionals to ensure the safety and comfort of animals during travel. Many pet owners struggle with transporting their pets safely, especially for long distances, medical emergencies, or when they cannot personally accompany their pets. Our professional pet transport services provide comprehensive door-to-door solutions with climate-controlled vehicles, secure carriers, and experienced animal handlers who understand pet behavior and stress management techniques. Our certified transport specialists are trained in animal care, emergency response, and travel regulations, with fully equipped vehicles that meet all safety and comfort standards. We understand that each pet has unique transportation needs based on size, temperament, health conditions, and travel distance. Unlike standard transportation options, we provide specialized care with proper restraint systems, regular comfort stops, hydration monitoring, and stress-reduction techniques. We work closely with veterinarians and pet owners to ensure all health requirements are met, necessary documentation is prepared, and your beloved pets arrive safely and comfortably at their destination while maintaining their well-being throughout the entire journey.
    </div>
    <a href="#booking-form" class="book-now-btn" onclick="scrollToForm()">Book Transport Service</a>
</section>

<section class="py-5" style="background-color: #f9fff9;">
  <div class="container">
    <h2 class="text-center mb-5 fw-bold" style="color: #1f2e4d;">Our Pet Transport Services</h2>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-3">
        <div class="card h-100 shadow-sm text-center border-0">
          <a href="#" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <img src="{{ asset('uploads/pet-transport/pexels-patricia-merl-1030568321-31751810.jpg') }}" alt="Local Transport" class="img-fluid rounded mb-3">
              <h5 class="card-title">Local Transport</h5>
              <p class="card-text">
                Safe local pet transport for vet visits, grooming, and short-distance travel with door-to-door service.
              </p>
            </div>
          </a>
        </div>
      ...
      <div class="col-md-3">
        <div class="card h-100 shadow-sm text-center border-0">
          <a href="#" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <img src="{{ asset('uploads/pet-transport/pexels-robertkso-17206212.jpg') }}" alt="Long Distance" class="img-fluid rounded mb-3">
              <h5 class="card-title">Long Distance</h5>
              <p class="card-text">
                Interstate pet transport with climate-controlled vehicles and regular comfort stops for extended journeys.
              </p>
            </div>
          </a>
        </div>
      ...
      <div class="col-md-3">
        <div class="card h-100 shadow-sm text-center border-0">
          <a href="#" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <img src="{{ asset('uploads/pet-transport/pexels-ozgur-surmeli-124841273-11782300.jpg') }}" alt="Emergency Transport" class="img-fluid rounded mb-3">
              <h5 class="card-title">Emergency Transport</h5>
              <p class="card-text">
                24/7 emergency pet transport for urgent veterinary care with rapid response and medical support.
              </p>
            </div>
          </a>
        </div>
      ...
      {{-- Box 4 --}}
       <div class="col-md-3">
          <div class="card h-100 shadow-sm text-center border-0">
            <a href="#" style="text-decoration: none; color: inherit;">
              <div class="card-body">
                <img src="{{ asset('uploads/pet-transport/pexels-aksakal-16264570.jpg') }}" alt="Airport Transport" class="img-fluid rounded mb-3">
                <h5 class="card-title">Airport Transport</h5>
                <p class="card-text">
                  Specialized airport transport service for pet air travel with documentation and cargo coordination.
                </p>
              </div>
            </a>
          </div>
...
<section class="py-5 booking-form-section" style="background-color: #f3f6fa;" id="booking-form">
  <div class="container">
    <h2 class="text-center fw-bold mb-4" style="color: #1f2e4d;">Book Pet Transport Service</h2>
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <form id="bookingForm" action="{{ route('booking.submit') }}" method="POST" onsubmit="handleSubmit(this)">
          ...
          <div class="mb-3">
            <label for="service" class="form-label">Select Pet Transport Service <span class="text-danger">*</span></label>
            <select class="form-select" id="service" name="service" required="">
              <option value="" disabled="" selected="">-- Select Pet Transport Service --</option>
               <option value="Local Pet Transport">Local Pet Transport</option>
                <option value="Long Distance Transport">Long Distance Transport</option>
                <option value="Emergency Pet Transport">Emergency Pet Transport</option>
                <option value="Airport Pet Transport">Airport Pet Transport</option>
                <option value="Veterinary Visit Transport">Veterinary Visit Transport</option>
                <option value="Grooming Appointment Transport">Grooming Appointment Transport</option>
                <option value="Pet Relocation Service">Pet Relocation Service</option>
                <option value="Multi-Pet Transport">Multi-Pet Transport</option>
                <option value="Senior Pet Transport">Senior Pet Transport</option>
                <option value="Special Needs Pet Transport">Special Needs Pet Transport</option>
              </select>
          </div>
    ...
    <div class="time-slots-container" id="timeSlotsContainer" style="display: none;">
        ...
        <div class="time-slots-content">
          ...
          <div class="mb-3">
            <label for="message" class="form-label">Special Instructions for Pet Transport (Optional)</label>
            <textarea class="form-control" id="message" name="message" rows="4" placeholder="Tell us about pickup/drop-off locations, your pet's size and temperament, any special needs, travel distance, or specific transport requirements..."></textarea>
          </div>

          <button type="submit" class="btn btn-success w-100" id="submitBtn">
            <span id="btnText">Book Pet Transport Service</span>
