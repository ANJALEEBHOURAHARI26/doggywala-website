  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 text-white">
        <h1 class="display-4 fw-bold mt-5">Welcome to Premium Pet Boarding</h1>
        <p class="lead">Safe, comfortable, and loving care for your pets while you're away. Book your pet's stay today!</p>
      </div>
    </div>
  </div>
</section>
...
<section class="py-5 bg-light">
  <div class="container">
    <h2 class="text-center fw-bold mb-5" style="color:#1f2e4d; font-size: 2.5rem;">Our Premium Boarding Services</h2>

    <div class="row align-items-center mb-5">
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="{{ asset('uploads/pet-boarding/pexels-dina-nasyrova-2006209-3764318.jpg') }}" alt="Dog Bath & Blow Dry" class="img-fluid rounded shadow w-100" style="max-height: 400px; object-fit: cover;">
      </div>
      <div class="col-md-6">
        <h3 class="fw-bold mb-3" style="color:#1f2e4d; font-size: 1.75rem;">Overnight Boarding</h3>
        <p style="font-size: 1.15rem; line-height: 1.9; color:#555;">
          Your pet will enjoy a comfortable stay in our spacious, climate-controlled facilities. Each pet gets individual attention, regular meals, exercise time, and a cozy sleeping area to ensure they feel safe and loved while you're away.
        </p>
    ...
    <div class="row align-items-center mb-5 flex-md-row-reverse">
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="{{ asset('uploads/pet-boarding/pexels-rdne-7516228.jpg') }}" alt="Haircut & Styling" class="img-fluid rounded shadow w-100" style="max-height: 400px; object-fit: cover;">
      </div>
      <div class="col-md-6">
        <h3 class="fw-bold mb-3" style="color:#1f2e4d; font-size: 1.75rem;">Pet Daycare</h3>
        <p style="font-size: 1.15rem; line-height: 1.9; color:#555;">
          Perfect for busy pet parents who need daily care. Your pets will enjoy supervised playtime, social interaction with other pets, regular feeding schedules, and plenty of attention throughout the day in a safe, fun environment.
        </p>
    ...
    <div class="row align-items-center mb-5">
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="{{ asset('uploads/pet-boarding/pexels-cottonbro-7085916.jpg') }}" alt="Nails, Ears & Hygiene" class="img-fluid rounded shadow w-100" style="max-height: 400px; object-fit: cover;">
      </div>
      <div class="col-md-6">
        <h3 class="fw-bold mb-3" style="color:#1f2e4d; font-size: 1.75rem;">Extended Stay Packages</h3>
        <p style="font-size: 1.15rem; line-height: 1.9; color:#555;">
          For longer trips, our extended stay packages offer special rates and premium care. Your pet will receive extra attention, daily updates with photos, customized feeding schedules, and additional playtime to keep them happy and healthy.
        </p>
...
<section class="py-5" style="background-color: #f9fff9;">
  <div class="container">
    <h2 class="text-center mb-5 fw-bold" style="color: #1f2e4d;">Our Boarding Services</h2>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-3">
        <div class="card h-100 shadow-sm text-center border-0">
          <a href="#" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <img src="{{ asset('uploads/pet-boarding/pets-on-holiday.jpg') }}" alt="Dog Bath & Blow Dry" class="img-fluid rounded mb-3">
              <h5 class="card-title">Overnight Boarding</h5>
              <p class="card-text">
                Safe & comfortable overnight stays with individual care.
      ...
      <div class="col-md-3">
        <div class="card h-100 shadow-sm text-center border-0">
          <a href="#" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <img src="{{ asset('uploads/pet-boarding/pexels-islandhopper-x-339537771-16234654.jpg') }}" alt="Haircut & Styling" class="img-fluid rounded mb-3">
              <h5 class="card-title">Pet Daycare</h5>
              <p class="card-text">
                Daily supervised play & social interaction for busy pet parents.
                <!-- <a href="#" class="read-more-btn">Read More</a> -->
              </p>
            </div>
          </a>
      ...
      <div class="col-md-3">
        <div class="card h-100 shadow-sm text-center border-0">
          <a href="#" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <img src="{{ asset('uploads/pet-boarding/pexels-karolina-grabowska-7693501.jpg') }}" alt="Nails, Ears & Hygiene" class="img-fluid rounded mb-3">
              <h5 class="card-title">Extended Stay</h5>
              <p class="card-text">
                Special packages for longer trips with premium care.
                <!-- <a href="#" class="read-more-btn">Read More</a> -->
              </p>
            </div>
          </a>
      ...
      {{-- Box 4 --}}
       <div class="col-md-3">
          <div class="card h-100 shadow-sm text-center border-0">
            <a href="#" style="text-decoration: none; color: inherit;">
              <div class="card-body">
                <img src="{{ asset('uploads/pet-boarding/pexels-bertellifotografia-16652420.jpg') }}" alt="Ear Cleaning" class="img-fluid rounded mb-3">
                <h5 class="card-title">Luxury Suites</h5>
                <p class="card-text">
                  Premium accommodations with extra space and special amenities for your beloved pet.
                  <!-- {{-- <a href="#" class="read-more-btn">Read More</a> --}} -->
                </p>
              </div>
            </a>
...
<section class="py-5 booking-form-section" style="background-color: #f3f6fa;" id="booking-form">
  <div class="container">
    <h2 class="text-center fw-bold mb-4" style="color: #1f2e4d;">Book Pet Boarding Appointment</h2>
            ...
            <select class="form-select" id="service" name="service" required="">
              <option value="" disabled="" selected="">-- Select Service--</option>
               <option value="Basic Boarding">Basic Boarding</option>
                <option value="Basic Boarding + Grooming">Basic Boarding + Grooming</option>
                <option value="Premium Boarding">Premium Boarding (All Services)</option>
