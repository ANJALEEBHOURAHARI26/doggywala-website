...
@section('main')
<section class="section-02" style="background-image: url('{{ asset('uploads/pet-boarding/petbacker-dog-boarding-1800x450.jpg') }}');">
  <div class="container">
    <div class="row">
      <div class="col-lg-8 text-white">
        <h1 class="display-4 fw-bold mt-5">Professional Pet Training Services</h1>
        <p class="lead">Expert training programs for dogs, cats, and other pets. Transform your pet's behavior with our certified trainers!</p>
      </div>
    </div>
  </div>
</section>
...
<section class="py-5 bg-light">
  <div class="container">
    <h2 class="text-center fw-bold mb-5" style="color:#1f2e4d; font-size: 2.5rem;">Our Professional Pet Training Programs</h2>

    <div class="row align-items-center mb-5">
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="{{ asset('uploads/pet-training/pexels-anton-kudryashov-118639843-14174176.jpg') }}" alt="Pet Obedience Training" class="img-fluid rounded shadow w-100" style="max-height: 400px; object-fit: cover;">
      </div>
      <div class="col-md-6">
        <h3 class="fw-bold mb-3" style="color:#1f2e4d; font-size: 1.75rem;">Basic Obedience Training</h3>
        <p style="font-size: 1.15rem; line-height: 1.9; color:#555;">
          Master the fundamentals with our comprehensive obedience training program. We teach essential commands like sit, stay, come, heel, and down. Our certified trainers use positive reinforcement techniques to build a strong foundation of trust and communication between you and your pet.
        </p>
      </div>
    </div>
    ...
    <div class="row align-items-center mb-5 flex-md-row-reverse">
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="{{ asset('uploads/pet-training/pexels-sam-lion-5731851.jpg') }}" alt="Behavioral Correction Training" class="img-fluid rounded shadow w-100" style="max-height: 400px; object-fit: cover;">
      </div>
      <div class="col-md-6">
        <h3 class="fw-bold mb-3" style="color:#1f2e4d; font-size: 1.75rem;">Behavioral Correction Training</h3>
        <p style="font-size: 1.15rem; line-height: 1.9; color:#555;">
          Address problematic behaviors with our specialized correction programs. We tackle issues like excessive barking, jumping, aggression, separation anxiety, and destructive behaviors. Our trainers develop customized solutions tailored to your pet's specific behavioral challenges.
        </p>
      </div>
    </div>
    ...
    <div class="row align-items-center mb-5">
      <div class="col-md-6 mb-4 mb-md-0">
        <img src="{{ asset('uploads/pet-training/pexels-mangalassery-5095299.jpg') }}" alt="Advanced Pet Training" class="img-fluid rounded shadow w-100" style="max-height: 400px; object-fit: cover;">
      </div>
      <div class="col-md-6">
        <h3 class="fw-bold mb-3" style="color:#1f2e4d; font-size: 1.75rem;">Advanced Training & Tricks</h3>
        <p style="font-size: 1.15rem; line-height: 1.9; color:#555;">
          Take your pet's skills to the next level with advanced training programs. Learn impressive tricks, agility training, specialized commands, and competition preparation. Perfect for pets who have mastered basic obedience and are ready for more challenging training exercises.
        </p>
      </div>
    </div>
...
<section class="pet-training-section">
    <div class="section-header">
        <h2 class="section-title">Why Choose Professional Pet Training?</h2>
    </div>
    
    <div class="section-description">
        Many pet owners struggle with behavioral issues, lack of obedience, and communication problems with their beloved pets. Without proper training, pets can develop destructive habits, anxiety, and aggression that affect the entire household. Our professional pet training services are designed to address these challenges through proven, science-based methods. Our certified trainers have years of experience working with dogs, cats, and other pets of all ages and temperaments. We use positive reinforcement techniques that build trust, respect, and strong bonds between pets and their owners. Unlike generic training approaches, we develop personalized training plans that address your pet's unique personality, learning style, and specific behavioral needs. Whether you have a new puppy, an adult rescue, or a senior pet with established habits, our training programs are designed to achieve lasting results. We provide ongoing support and guidance to ensure your pet's training success continues long after our sessions end.
    </div>
    <a href="#booking-form" class="book-now-btn" onclick="scrollToForm()">Book Training Session</a>
</section>

<section class="py-5" style="background-color: #f9fff9;">
  <div class="container">
    <h2 class="text-center mb-5 fw-bold" style="color: #1f2e4d;">Our Pet Training Services</h2>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-3">
        <div class="card h-100 shadow-sm text-center border-0">
          <a href="#" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <img src="{{ asset('uploads/pet-training/pexels-goochie-poochie-3299906.jpg') }}" alt="Puppy Training" class="img-fluid rounded mb-3">
              <h5 class="card-title">Puppy Training</h5>
              <p class="card-text">
                Early socialization and basic training for puppies aged 8-16 weeks. Build good habits from the start.
              </p>
            </div>
          </a>
        </div>
      ...
      <div class="col-md-3">
        <div class="card h-100 shadow-sm text-center border-0">
          <a href="#" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <img src="{{ asset('uploads/pet-training/pexels-zen-chung-5745275.jpg') }}" alt="Adult Dog Training" class="img-fluid rounded mb-3">
              <h5 class="card-title">Adult Dog Training</h5>
              <p class="card-text">
                Comprehensive obedience and behavioral training for adult dogs of all breeds and sizes.
              </p>
            </div>
          </a>
        </div>
      ...
      <div class="col-md-3">
        <div class="card h-100 shadow-sm text-center border-0">
          <a href="#" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <img src="{{ asset('uploads/pet-training/pexels-pitipat-usanakornkul-542797332-16597604.jpg') }}" alt="Cat Training" class="img-fluid rounded mb-3">
              <h5 class="card-title">Cat Training</h5>
              <p class="card-text">
                Specialized training programs for cats including litter training, scratching behavior, and basic commands.
              </p>
            </div>
          </a>
        </div>
      ...
      {{-- Box 4 --}}
       <div class="col-md-3">
          <div class="card h-100 shadow-sm text-center border-0">
            <a href="#" style="text-decoration: none; color: inherit;">
              <div class="card-body">
                <img src="{{ asset('uploads/pet-training/pexels-rdne-7516307.jpg') }}" alt="Behavioral Training" class="img-fluid rounded mb-3">
                <h5 class="card-title">Behavioral Training</h5>
                <p class="card-text">
                  Specialized programs to address aggression, anxiety, fear, and other behavioral issues in pets.
                </p>
              </div>
            </a>
          </div>
...
<section class="py-5 booking-form-section" style="background-color: #f3f6fa;" id="booking-form">
  <div class="container">
    <h2 class="text-center fw-bold mb-4" style="color: #1f2e4d;">Book Pet Training Session</h2>
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <form id="bookingForm" action="{{ route('booking.submit') }}" method="POST" onsubmit="handleSubmit(this)">
          ...
          <div class="mb-3">
            <label for="service" class="form-label">Select Pet Training Service <span class="text-danger">*</span></label>
            <select class="form-select" id="service" name="service" required="">
              <option value="" disabled="" selected="">-- Select Pet Training Service --</option>
               <option value="Basic Obedience Training">Basic Obedience Training</option>
                <option value="Advanced Obedience Training">Advanced Obedience Training</option>
                <option value="Puppy Training Program">Puppy Training Program</option>
                <option value="Behavioral Correction Training">Behavioral Correction Training</option>
                <option value="Cat Training & Behavior">Cat Training & Behavior</option>
                <option value="Agility Training">Agility Training</option>
                <option value="Socialization Training">Socialization Training</option>
                <option value="Potty Training">Potty Training</option>
                <option value="Leash Training">Leash Training</option>
    ...
    <div class="time-slots-container" id="timeSlotsContainer" style="display: none;">
        ...
        <div class="time-slots-content">
          ...
          <div class="mb-3">
            <label for="message" class="form-label">Special Instructions for Pet Training (Optional)</label>
            <textarea class="form-control" id="message" name="message" rows="4" placeholder="Tell us about your pet's current behavior, training goals, or any specific issues you'd like to address..."></textarea>
          </div>

          <button type="submit" class="btn btn-success w-100" id="submitBtn">
            <span id="btnText">Book Pet Training Session</span>
